...
#include "ui_dialogaboutloss.h"

DialogAboutLoss::DialogAboutLoss(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::DialogAboutLoss)
{
    ui->setupUi(this);

    setStyleSheet("DialogAboutLoss {background-color: "
...
DialogAboutLoss::~DialogAboutLoss()
{
    delete ui;
}
